...
public class Role extends BaseTest {
	...
	public void Account_01_Add_New_Account() {
		...
		accountListPage = PageGenerator.getUserListPage(driver);
		...
		detailAccountPage = PageGenerator.getDetailUserPage(driver);
	...
	public void Account_02_Edit_Account() {
		...
		editAccountPage = PageGenerator.getEditUserPage(driver);
