...
public class CardReader extends BaseTest {
	...
	AddDOEventPageObject addDOEventPage;
	EditDOEventPageObject editDOEventPage;
	...
	public void CardReader_01_Add_New_CardReader() {
		...
		addCardReaderPage.selectItemInCustomDropdownByAttribute(driver, "ac-controllers-search-input", Controller.controllerNameUpdateCookie);
		...
		verifyEquals(detailCardReaderPage.getValueFieldByAttribute(driver, "controller"), Controller.controllerNameUpdateCookie);
