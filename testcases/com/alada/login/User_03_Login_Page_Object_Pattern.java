...
public class User_03_Login_Page_Object_Pattern {
	...
	/*
	 * @Test public void TC_02_Login_With_Invalid_Email() {
	 * loginPage.enterToEmailTextbox("automation@&^*");
	 * loginPage.enterToPasswordTextbox("123456"); loginPage.clickLoginButton();
	 ...
	 * "Vui lòng nhập email hợp lệ"); }
	 * 
	 * @Test public void TC_03_Login_With_Email_Not_Registed() {
	 * loginPage.enterToEmailTextbox("automation" + getRandomNumber() +
	 * "@hotmail.com"); loginPage.enterToPasswordTextbox("123456");
	 * loginPage.clickLoginButton();
	 * Assert.assertEquals(loginPage.getErrorMessageAtLoginForm(),
	 * "Email này chưa được đăng ký."); }
	 * 
	 * @Test public void TC_04_Login_Password_Invalid() { //Invalid Password
	 * loginPage.enterToEmailTextbox("automationfc.vn@hotmail.com");
	 * loginPage.enterToPasswordTextbox("123"); loginPage.clickLoginButton();
	 * Assert.assertEquals(loginPage.getErrorMessageAtLoginForm(), "Mật khẩu sai.");
	 * 
	 * //Incorrect Password
	 * loginPage.enterToEmailTextbox("automationfc.vn@hotmail.com");
	 * loginPage.enterToPasswordTextbox("123456789"); loginPage.clickLoginButton();
	 * Assert.assertEquals(loginPage.getErrorMessageAtLoginForm(), "Mật khẩu sai.");
	 * }
	 * 
	 * @Test public void TC_05_Login_Valid_Email_Password() {
	 * loginPage.loginToSystem("automationfc.vn@hotmail.com", "123456"); homePage =
